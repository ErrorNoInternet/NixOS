...
in {
  ...
  config = mkIf config.customPrograms.graphical.kdeconnect.enable {
    services.kdeconnect.enable = true;
    home.file.".config/kdeconnect/${config.customPrograms.graphical.kdeconnect.deviceId}/kdeconnect_runcommand/config".text = ''
      [General]
