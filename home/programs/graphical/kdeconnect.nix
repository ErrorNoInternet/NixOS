...
in {
  options.home.programs.graphical.kdeconnect = {
  ...
  config = mkIf config.home.programs.graphical.kdeconnect.enable {
    services.kdeconnect.enable = true;
    home.file.".config/kdeconnect/${config.home.programs.graphical.kdeconnect.deviceId}/kdeconnect_runcommand/config".text = ''
      [General]
