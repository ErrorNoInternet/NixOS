  ...
  in {
    settings = {
      bind = [
        ...
        "SHIFT, code:87, workspace, 1"
        "SHIFT, code:88, workspace, 2"
        "SHIFT, code:89, workspace, 3"
        "SHIFT, code:83, workspace, 4"
        "SHIFT, code:84, workspace, 5"
        "SHIFT, code:85, workspace, 6"
        "SHIFT, code:79, workspace, 7"
        "SHIFT, code:80, workspace, 8"
        "SHIFT, code:81, workspace, 9"
        "SHIFT, code:90, workspace, 10"
